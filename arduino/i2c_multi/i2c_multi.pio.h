...
#define start_condition_wrap_target 4
#define start_condition_wrap 6
#define start_condition_pio_version 0

#define start_condition_offset_start 4u

static const uint16_t start_condition_program_instructions[] = {
    0x2021, //  0: wait   0 pin, 1
    0xf800, //  1: set    pins, 0         side 1
    0xc021, //  2: irq    wait 1
    0xd004, //  3: irq    nowait 4        side 0
            //     .wrap_target
