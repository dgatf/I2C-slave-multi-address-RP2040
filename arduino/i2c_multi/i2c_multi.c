...
void i2c_multi_init(PIO pio, uint pin) {
    ...
    pio_sm_put_blocking(pio, i2c_multi->sm_read,
...
static inline void byte_handler_pio(void) {
    ...
    if (i2c_multi->status == I2C_WRITE && is_address) {
        ...
        pio_sm_put_blocking(i2c_multi->pio, i2c_multi->sm_write,
    ...
    if (i2c_multi->status == I2C_WRITE && !is_address) {
        ...
        pio_sm_put_blocking(i2c_multi->pio, i2c_multi->sm_write,
                            (((uint32_t)wait_ack_program_instructions[9] + i2c_multi->offset_write) << 16) |
                                (wait_ack_program_instructions[8]));
        pio_sm_put_blocking(i2c_multi->pio, i2c_multi->sm_write, value);
        pio_sm_put_blocking(i2c_multi->pio, i2c_multi->sm_write,
                            (((uint32_t)wait_ack_program_instructions[1]) << 16) | wait_ack_program_instructions[0]);
        pio_sm_put_blocking(i2c_multi->pio, i2c_multi->sm_write,
